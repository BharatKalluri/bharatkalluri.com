...
- Once the package idea clicks, it is very easy to run the app just using pycharm. Set your package folder as `sources
root`. It essentially adds the folder in `PYTHONPATH` which makes it to be considered as a python package. Create a
