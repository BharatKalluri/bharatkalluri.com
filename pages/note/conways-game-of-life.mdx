...
I've heard about this game on The Joe Rogan podcast with Lex friedman (#1537). Lex talks about cellular automata,
...
2.  Deaths. Each counter with four or more neighbors dies (is removed) from overpopulation. Every counter with one
    neighbor or none dies from isolation.
3.  Births. Each empty cell adjacent to exactly three neighbors--no more, no fewer--is a birth cell. A counter is placed
    on the next move
...
<iframe src="https://editor.p5js.org/BharatKalluri/embed/0CfHbzr4d"></iframe>
