---
title: Create an Albert extension using Python
...
I consider myself as a mediocre developer. I would not have tried writing extensions
using C++, but I can certainly write extensions using python!
