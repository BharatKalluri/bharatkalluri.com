...
quality long term is by automation. Remember to [make it easy and make it obvious](/post/atomic-habits). Git hooks are
...
These are some of the common hooks (note that all of the hooks listed below are local)
