...
Its nine in the night and the servers alarms are going off, CRONs have overloaded the systems and main traffic is chocking sometimes as the new instances kick in. The team has to do something, and so something soon. What's the simplest change we can do to get things back to normal.
