...
<YoutubeEmbed youtubeID="RvdQfru-yn8" />
...
Lets jump in time to 1694, **Gottfried Wilhelm Leibniz** wanted to make computation easier and better. So he invented something called a
...
machine was used by the infamous Manhattan project. This machine was _huge_, [read through the wiki to understand more](https://en.wikipedia.org/wiki/Harvard_Mark_I).

![Harvard Mark One](https://sites.harvard.edu/~chsi/markone/images/Mark1HousingSmall.jpg)
...
since there is no moving parts. And _they are fast_, a relay can probably turn on and off around 30 times a second. A vacuum tube
...
smaller and faster. In 1947, three scientists from bell labs made the next leap. _Transistors_.
...
Now that we can turn switches on and off super fast, how do we make use of this to do calculations? Enter _logic gates_.
