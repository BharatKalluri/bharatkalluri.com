---
title: Auto muting when spotify plays advertisement
description: A nifty hack to mute spotify whenever it plays an advert
hero: https://unsplash.com/photos/634KBk3AXNA/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjM5MjAxMjE3&force=true&w=640
