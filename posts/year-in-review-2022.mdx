...
description: Picked up running, went on some awesome treks and much more!
...
A year is a _long time_, a lot of things happen in an years timeframe. This is a look back on what happened in 2022, highlights & reflections.
...
The theme for the last year for the company has been _speed & quality_. This year was around _stability, performance & scale_. The team has near about tripled and dynamics change as the company grows.
...
Nothing here, I've started a [wiki](https://wiki.bharatkalluri.com/) where some interesting pieces were written. Also started writing [notes](https://bharatkalluri.com/notes). Starting to slowly get back in the rhythm. Will try and make the next year better in this dimension.
