---
title: Principles for programming
description: My personal philosophy's around programming
...
-   Think in terms of experience. If you are working on a backend server, think about the experience of the frontend web developer who will be consuming the API. If you are a platform engineer, think about the experience of the developers who will be using your API. If you are a frontend web developer, think in terms of user experience. Always strive to make everything as "intutive" as possible.
...
-   Read [Zen of python](https://peps.python.org/pep-0020/#the-zen-of-python), keep re-reading it until it fully sinks in
